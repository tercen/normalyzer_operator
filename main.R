...
#   "none"
# )
# NormalyzerDE::globalIntensityNormalization()
# NormalyzerDE::medianNormalization()
# NormalyzerDE::meanNormalization()
# NormalyzerDE::performVSNNormalization()
# NormalyzerDE::performQuantileNormalization()
# NormalyzerDE::performSMADNormalization()
# NormalyzerDE::performCyclicLoessNormalization()
# NormalyzerDE::performGlobalRLRNormalization()
